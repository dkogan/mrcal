...
** calibrate-cameras
#+BEGIN_EXAMPLE
xxx-manpage-calibrate-cameras-xxx
#+END_EXAMPLE
** convert-distortion
#+BEGIN_EXAMPLE
xxx-manpage-convert-distortion-xxx
#+END_EXAMPLE
** show-distortion
#+BEGIN_EXAMPLE
xxx-manpage-show-distortion-xxx
#+END_EXAMPLE
** show-intrinsics-uncertainty
#+BEGIN_EXAMPLE
xxx-manpage-show-intrinsics-uncertainty-xxx
#+END_EXAMPLE
** show-intrinsics-diff
#+BEGIN_EXAMPLE
xxx-manpage-show-intrinsics-diff-xxx
#+END_EXAMPLE
** undistort-image
#+BEGIN_EXAMPLE
xxx-manpage-undistort-image-xxx
#+END_EXAMPLE
** redistort-points
#+BEGIN_EXAMPLE
xxx-manpage-redistort-points-xxx
#+END_EXAMPLE
** graft-cameramodel
#+BEGIN_EXAMPLE
xxx-manpage-graft-cameramodel-xxx
#+END_EXAMPLE
