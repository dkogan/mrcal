...
//
// All functions are defined using the mrcal_..._noncontiguous() form, which
// supports non-contiguous input and output arrays. Strides are used to specify
// the array layout.
//
// All functions have a convenience wrapper macro that is a simpler way to call
// the function when contiguous arrays are available
//
...
// mrcal_..._noncontiguous() functions, each array is followed by the strides,
// one per dimension.
//
