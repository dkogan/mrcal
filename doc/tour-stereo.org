...
$PYTHONPATH/mrcal--stereo                                           \
  ...
  --set 'view 70,5'                                                 \
  --viz geometry                                                    \
  --hardcopy ~/projects/mrcal/doc/external/figures/stereo/stereo-rectified-system.svg          \
...
$PYTHONPATH/mrcal-stereo                                            \
  ...
  --set 'view 70,5'                                                 \
  --viz geometry                                                    \
  --hardcopy ~/projects/mrcal/doc/external/figures/stereo/stereo-rectified-system-narrow.svg   \
  --terminal 'svg size 800,600 noenhanced solid dynamic font ",14"' \
  $D1/splined-[01].cameramodel
#+end_src
