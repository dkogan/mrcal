...
mrcal-show-splined-model-surface splined.cameramodel y \
                                 --set 'cbrange [-.1:.1]' --unset key
#+end_src
...
#+begin_src sh :exports none :eval no-export
for xy (x y) { ~/jpl/mrcal/mrcal-show-splined-model-surface data/board/splined.cameramodel --set 'cbrange [-.1:.1]' $xy --unset key --hardcopy ~/jpl/mrcal/doc/external/figures/splined-models/splined-knots-$xy.png --terminal 'pngcairo size 1024,768 transparent noenhanced crop          font ",12"' }

for xy (x y) { ~/jpl/mrcal/mrcal-show-splined-model-surface --imager-domain --set 'xrange [-300:6300]' --set 'yrange [4300:-300]' data/board/splined.cameramodel --set 'cbrange [-.1:.1]' $xy --unset key --hardcopy ~/jpl/mrcal/doc/external/figures/splined-models/splined-knots-pixel-domain-$xy.png --terminal 'pngcairo size 1024,768 transparent noenhanced crop          font ",12"' }
#+end_src
...
#+begin_src sh :exports none :eval no-export
mrcal-show-projection-diff --intrinsics-only --cbmax 200 --unset key data/board/opencv8.cameramodel data/board/splined.cameramodel \
  --hardcopy ~/jpl/mrcal/doc/external/figures/diff/diff-radius0-heatmap-splined-opencv8.png --terminal 'pngcairo size 1024,768 transparent noenhanced crop          font ",12"'
#+end_src
...
#+begin_src sh :exports none :eval no-export
mrcal-show-projection-diff --intrinsics-only --cbmax 200 --unset key --vectorfield --vectorscale 5 --gridn 30 20 data/board/opencv8.cameramodel data/board/splined.cameramodel \
  --hardcopy ~/jpl/mrcal/doc/external/figures/diff/diff-radius0-vectorfield-splined-opencv8.svg --terminal 'svg size 800,600 noenhanced solid dynamic font ",14"'

mrcal-show-projection-diff --intrinsics-only --cbmax 200 --unset key --vectorfield --vectorscale 5 --gridn 30 20 data/board/opencv8.cameramodel data/board/splined.cameramodel \
  --hardcopy ~/jpl/mrcal/doc/external/figures/diff/diff-radius0-vectorfield-splined-opencv8.pdf  --terminal 'pdf size 8in,6in       noenhanced solid color   font ",12"'
#+end_src
...
mrcal-show-projection-diff --unset key data/board/opencv8.cameramodel data/board/splined.cameramodel \
  --hardcopy ~/jpl/mrcal/doc/external/figures/diff/diff-splined-opencv8.png --terminal 'pngcairo size 1024,768 transparent noenhanced crop          font ",12"'
#+end_src
...
[[https://www.github.com/dkogan/mrcal/blob/master/doc/stereo.py][=stereo.py=]]. We run it like this:
...
[[file:external/data/figueroa-overpass-looking-S/rectified0-splined.jpg][file:external/figures/stereo/rectified0-splined.downsampled.jpg]]
[[file:external/data/figueroa-overpass-looking-S/rectified1-splined.jpg][file:external/figures/stereo/rectified1-splined.downsampled.jpg]]

And the disparity and range images looks like this:

[[file:external/data/figueroa-overpass-looking-S/disparity-splined.png][file:external/figures/stereo/disparity-splined.downsampled.png]]
[[file:external/data/figueroa-overpass-looking-S/range-splined.png][file:external/figures/stereo/range-splined.downsampled.png]]
...
#+begin_src sh :exports none :eval no-export
what=opencv8; (
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 2874 1231 --range-estimate 566 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 2968 1767 --range-estimate 870 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 1885 864  --range-estimate 594 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 3090 1384 --range-estimate 862 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg  541  413 --range-estimate 402 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 4489 1631 --range-estimate 522 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 5483  930 --range-estimate 311 --searchradius 10
./mrcal-triangulate $D/$what-[01].cameramodel $D/[01].jpg 5351  964 --range-estimate 311 --searchradius 10
) | egrep 'q1|Range'
#+end_src
...
Here we see that jplv's rectification function also has some implicit pinhole
projection assumption in there, and the scale within each row is dramatically
uneven.
...
[[file:external/data/figueroa-overpass-looking-S/rectified0-narrow.jpg][file:external/figures/stereo/rectified0-narrow.downsampled.jpg]]
[[file:external/data/figueroa-overpass-looking-S/rectified1-narrow.jpg][file:external/figures/stereo/rectified1-narrow.downsampled.jpg]]
