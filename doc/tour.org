...
extremes. More or less we look at each row in the rectified image in isolation,
so this is OK. Some other implementations use un-even azimuth spacing, which
can't be good for matching performance.
