...
errors [[file:differencing.org::#fitting-data-selection\]\[file:~/projects/mrcal/doc/differencing.org::#fitting-data-selection][increasing as we include more and more of the imager towards the corners]].
