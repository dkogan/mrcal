...
mrcal-show-residuals-board-observation \
  ...
  $D/opencv8.cameramodel \
  0
Dout_worst=~/projects/mrcal-doc-external/figures/calibration/worst
mkdir -p $Dout_worst
...
The previous radial pattern is still there, but is much less pronounced. A
