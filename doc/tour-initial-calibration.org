...
We /do/ still see a clear pattern in the directions, so this fit quality can
still be improved: a denser spline spacing would do better. This is a peculiar
image processing artifact of the Sony Alpha 7 III camera: other cameras using
this lens do not exhibit this effect.
