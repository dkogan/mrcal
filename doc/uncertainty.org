...
The [[file:mrcal-python-api.html#-projection_uncertainty][=mrcal.projection_uncertainty()=]] function implements this logic, which can
...
is set by the specifics of the chessboard dance. See the [[file:tour.org::*Optimal choreography][for a study]].

More uncertainty results are reported in the [[file:tour.org::*Projection uncertainty][tour]].
