...
is set by the specifics of the chessboard dance. See the [[file:tour.org::*Optimal choreography][tour of mrcal]] for a
study.

More uncertainty results are reported in the [[file:tour.org::*Projection uncertainty][tour of mrcal]].
