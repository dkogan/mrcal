...
It computes faster than the splined model, and qualitatively produces the
similar results.
...
PYTHONPATH=/home/dima/projects/mrcal             \
~/projects/mrcal/analyses/dancing/dance-study.py \
  --scan Nframes                                 \
  --Ncameras 1                                   \
  --Nframes 20,200                               \
  --range 0.5                                    \
