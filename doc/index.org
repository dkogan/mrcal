...
links to board/ must work. Make sure tour/narrow-section and tour/stereo links work

search for yyy everywhere

add triangulation tool to stereo.py

** re-read

- [[file:how-to-calibrate.org]]
- [[file:differencing.org]]
- [[file:tour.org]]
