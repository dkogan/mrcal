...
- [[file:mrcal-python-api-reference.html#-compose_R][=mrcal.compose_R()=]]: Compose R rotations. This is a matrix multiplication
...
- [[file:mrcal-python-api-reference.html#-corresponding_icam_extrinsics][=mrcal.corresponding_icam_extrinsics()=]]: Return the icam_extrinsics
  corresponding to a given icam_intrinsics. Works with stationary cameras
