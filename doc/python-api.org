...
- [[file:mrcal-python-api-reference.html#-residuals_board][=mrcal.residuals_board()=]]: Compute and return the chessboard measurements (weighted reprojection errors)
- [[file:mrcal-python-api-reference.html#-residuals_point][=mrcal.residuals_point()=]]: Compute and return the discrete point measurements (weighted reprojection errors)
