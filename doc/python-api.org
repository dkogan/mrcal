...
- [[file:mrcal-python-api-reference.html#-hypothesis_chessboard_corner_positions][=mrcal.hypothesis_chessboard_corner_positions()=]]: Reports the coordinates of chessboard
