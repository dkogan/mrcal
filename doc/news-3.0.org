...
-  C API: quiet versions of the cameramodel-parsing functions
  
  New functions:
  
  - mrcal_read_cameramodel_string2()
  - mrcal_read_cameramodel_file2()
  - mrcal_read_cameramodel_string_into2()
  - mrcal_read_cameramodel_file_into2()
  
  Each has a new "quiet" argument, not present in the original
