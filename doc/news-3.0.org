...
2024-12-06 compose_r() has new args: inverted0,inverted1 BREAKING C ABI,API
  change: mrcal_compose_r_full() takes the two new arguments. The
  mrcal_compose_r() macro and the Python functions maintain the same interface
