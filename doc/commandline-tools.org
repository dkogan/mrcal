...
- [[file:mrcal-stereo.html][=mrcal-stereo=]]: Given pairs of images captured by a given pair of camera
  models, runs stereo matching to produce disparity and range images.
