...
- [[https://github.jpl.nasa.gov/maritime-robotics/mrcal/blob/master/triangulation.h][=triangulation.h=]]: tringulation routines
...
* Triangulation
A number of triangulation routines are available in [[https://github.jpl.nasa.gov/maritime-robotics/mrcal/blob/master/triangulation.h][=triangulation.h=]]. These
...
* Optimization
The mrcal [[file:formulation.org][optimization routines]] are defined in [[https://github.jpl.nasa.gov/maritime-robotics/mrcal/blob/master/mrcal.h][=mrcal.h=]]. There are two primary
