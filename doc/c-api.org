...
- =mrcal_lensmodel_type_t=: an enum decribing the lens model /type/. No [[file:index.org::Lens models][configuration]] is stored here.
- =mrcal_lensmodel_t=: a lens model type /and/ the [[file:index.org::Lens models][configuration]] parameters. The
