...
# These are disabled because CAHVORE doesn't work yet. I need to confirm that
# it's actually doing the right thing, and I need to fully add support for
# noncentral projections in order for this to work
if 0:
