...
def unproject(q, distortion_model, intrinsics_data):
    ...
    if distortion_model == "DISTORTION_NONE":
        ...
        # This runs a nonlinear optimization, and I don't want to do it in
        # Python. I use OpenCV if I can, and do the python optimization
        # otherwise. I could (probably should) move all this to my C layer
        # instead
