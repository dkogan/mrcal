...
OPTIONS
  POSITIONAL ARGUMENTS
      model                 Input camera model. If "-' is given, we read standard
                            input
      {0,1}                 Whether we're looking at the x surface (0) or the y
                            surface (1)
...
OPTIONS
  ...
  OPTIONAL ARGUMENTS
      -h, --help            show this help message and exit
      --observations-xydist
                            If given, I make a 3D plot of uncertainties and
                            chessboard observations. With this option I ignore
                            --distance, --isotropic, --observations, --cbmax. This
                            option makes a 3D x-y-distance plot instead of the 2D
      ...
      --distance DISTANCE   By default we display the projection uncertainty
                            infinitely away from the camera. If we want to look
                            closer in, the desired observation distance can be
      ...
      --isotropic           By default I display the expected value of the
                            ...
                            this error. If we want to plot the mean of the worst
...
OPTIONS
  ...
  OPTIONAL ARGUMENTS
      ...
      --fit FIT             If we generate a target pinhole model (if --to-pinhole
                            ...
                            x0,y0,x1,y1,x2,y2,.... The focal length scale woudl
...
OPTIONS
  POSITIONAL ARGUMENTS
      intrinsics  Input camera model for the intrinsics. If "-' is given, we read
                  standard input
      extrinsics  Input camera model for the extrinsics. If "-' is given, we read
                  standard input
...
OPTIONS
  ...
  OPTIONAL ARGUMENTS
      -h, --help           show this help message and exit
      --writeimage         By default I make a plot. If --writeimage is given, I
                           output an annotated image instead
